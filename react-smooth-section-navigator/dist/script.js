const App = () => {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement(Section, { id: "first", title: "City Skyline", className: "first", bgUrl: "https://images.unsplash.com/photo-1605629713998-167cdc70afa2?crop=entropy&cs=srgb&fm=jpg&ixid=M3wzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2OTg2OTM1NTR8&ixlib=rb-4.0.3&q=85" }), /*#__PURE__*/
    React.createElement(Section, { id: "second", title: "Flowers of friendship", className: "second", bgUrl: "https://images.unsplash.com/photo-1503796964332-e25e282e390f?crop=entropy&cs=srgb&fm=jpg&ixid=M3wzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2OTg2OTM1NTR8&ixlib=rb-4.0.3&q=85" }), /*#__PURE__*/
    React.createElement(Section, { id: "third", title: "Waves in the Ocean", className: "third", bgUrl: "https://images.unsplash.com/photo-1518156677180-95a2893f3e9f?crop=entropy&cs=srgb&fm=jpg&ixid=M3wzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2OTg2OTM1OTh8&ixlib=rb-4.0.3&q=85" }), /*#__PURE__*/
    React.createElement(Section, { id: "fourth", title: "New York City", className: "fourth", bgUrl: "https://images.unsplash.com/photo-1584351583369-6baf055b51a7?crop=entropy&cs=srgb&fm=jpg&ixid=M3wzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE2OTg2OTM4MTB8&ixlib=rb-4.0.3&q=85" }), /*#__PURE__*/
